      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4 border-b border-slate-800 pb-6">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs">
            <a
              ...
              className="px-3.5 py-2 rounded-xl bg-emerald-950/40 border border-emerald-500/30 text-emerald-400 hover:text-emerald-300 hover:border-emerald-400 transition flex items-center gap-1.5 font-bold"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-3.5 py-2 rounded-xl bg-pink-950/40 border border-pink-500/30 text-pink-400 hover:text-pink-300 hover:border-pink-400 transition flex items-center gap-1.5 font-bold"
            >
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-3.5 py-2 rounded-xl bg-red-950/40 border border-red-500/30 text-red-400 hover:text-red-300 hover:border-red-400 transition flex items-center gap-1.5 font-bold"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-3.5 py-2 rounded-xl bg-cyan-950/40 border border-cyan-500/30 text-cyan-400 hover:text-cyan-300 hover:border-cyan-400 transition flex items-center gap-1.5 font-bold"
            >
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredVideos.map((video) => (
            <div
              key={video.id}
              className="bg-slate-900/80 border border-slate-800 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition duration-300 shadow-xl group"
            >
              <div>
                {/* Media Container */}
                <div className="relative aspect-video bg-slate-950 overflow-hidden">
                  {video.platform === 'youtube' && video.embedId ? (
                    ...
                    >
                      ...
                      {/* TikTok Badge */}
                      <div className="absolute top-3 left-3 bg-slate-950/80 backdrop-blur-md px-2.5 py-1 rounded-lg text-[10px] font-bold text-cyan-400 border border-cyan-500/30 flex items-center gap-1">
                ...
                <div className="p-4 space-y-2">
                  <div className="flex items-center justify-between text-[11px]">
                    ...
                    {video.views && <span className="text-slate-400 font-mono">{video.views}</span>}
                  </div>
              ...
              {/* Action Footer */}
              <div className="px-4 py-3 border-t border-slate-800/60 bg-slate-950/50 flex items-center justify-between text-xs">
                {video.platform === 'youtube' ? (
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-cyan-400 hover:text-cyan-300 font-bold flex items-center gap-1.5 transition"
                  >
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64c.29 0 .58.04.86.12V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 003 15.68a6.34 6.34 0 0010.86 4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.04z"/>
                    </svg>
