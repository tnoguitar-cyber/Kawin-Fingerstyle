                ...
                {product.youtubeEmbedUrl && (
                  <button
                    onClick={() => setActiveVideoModal({
                      title: `🎬 วิดีโอตัวอย่าง ${product.thaiName}`,
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl space-y-4 border border-stone-200 dark:border-none max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 space-y-4 overflow-y-auto">
              ...
              {detailProduct.youtubeEmbedUrl && (
                <div className="p-4 rounded-xl bg-red-500/5 dark:bg-red-950/20 border border-red-500/20 space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-stone-900 dark:text-white flex items-center gap-1.5">
                      ...
                      <span>🎬 วิดีโอตัวอย่างประกอบ {detailProduct.thaiName}</span>
                    </span>
                    {detailProduct.youtubeVideoUrl && (
                      <a
                        href={detailProduct.youtubeVideoUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                  ...
                  <div className="w-full max-w-[280px] mx-auto aspect-[9/16] rounded-xl overflow-hidden border border-stone-200 dark:border-slate-800 shadow-lg bg-slate-950">
                    <iframe
                      src={detailProduct.youtubeEmbedUrl}
                      title={`${detailProduct.thaiName} Video Preview`}
